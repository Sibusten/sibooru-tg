# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in sibooru.
...
base_config.model = sibooru.model
base_config.DBSession = sibooru.model.DBSession
